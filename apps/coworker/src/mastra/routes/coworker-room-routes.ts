...
import { coworkerStartRequestSchema } from '../../../../../packages/shared/src/index';
import { coworkerRoomRegistry } from '../collaboration/coworker-room-registry';

// 这组 custom API routes 是 coworker 的控制面，只负责进入、查询、退出 room。
// 画布读写仍然通过 coworker 自己的 tldraw sync client 走协同边界。
export const coworkerRoomApiRoutes = [
